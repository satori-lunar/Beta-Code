...
async function importContacts() {
  ...
  console.log('\n💡 Note: Users have been created with default password: Welcome2025!');
  console.log('   Users can sign in with their email and this password.');
  console.log('   They can change their password after first login if desired.');
  console.log('\n✅ Data isolation is already configured via Row Level Security (RLS).');
  console.log('   Each user will only see their own data in the dashboard.');
}
